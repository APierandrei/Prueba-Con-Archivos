...
public class CreandoArchivos {
	...
	public static void creandoArchivo(String ruta, String unTexto) throws IOException {
		File fopen = new File (ruta); //este forma de creación sobreescribe el archivo si existe, pero no puede crear las carpeta si no existen previamente.
	...
	public static void main(String[] args) throws IOException {
		// archivo creado en la ruta por defecto del proyecto si no se agrega ninguna ruta. Para indicar las carpetas se usa "/" en lugar de "\".
